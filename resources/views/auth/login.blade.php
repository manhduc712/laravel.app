...
@section('content')
    <h1 class="text-center p-2 font-bold text-xl">Đăng nhập</h1>
    <main class="flex justify-center">
        <div class="w-full flex justify-center">
            <div
                class=" w-8/12 rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
